...
public class Player : MonoBehaviour
{
	...
	public static bool disableMovement;//true if the player is moving //true when the player is not inteded to move
    public string sceneBeforeBattle;
	public static Vector2 lastMove; //hold the direction of the last move
	private Rigidbody2D myRigidbody;
	private static bool playerExists; //true if the player exists anywhere in the code
	public static bool movingByScript; //true if a scripted moment is going
    void Start() 
	{	
	...
	private void MoveByInput() //function that makes the player move
	{	
		playerMoving = false;
